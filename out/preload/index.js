...
/* ESM import */var _electron_toolkit_preload__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./node_modules/@electron-toolkit/preload/dist/index.mjs");
...
if (process.contextIsolated) {
    try {
        electron__WEBPACK_IMPORTED_MODULE_0__.contextBridge.exposeInMainWorld('electron', _electron_toolkit_preload__WEBPACK_IMPORTED_MODULE_1__.electronAPI);
        electron__WEBPACK_IMPORTED_MODULE_0__.contextBridge.exposeInMainWorld('api', api);
    } catch (error) {
        console.error(error);
    }
} else {
    // @ts-ignore (define in dts)
    window.electron = _electron_toolkit_preload__WEBPACK_IMPORTED_MODULE_1__.electronAPI;
    // @ts-ignore (define in dts)
    window.api = api;
}
