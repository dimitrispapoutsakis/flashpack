...
/* ESM import */var path__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("path");
...
/* ESM import */var _electron_toolkit_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./node_modules/@electron-toolkit/utils/dist/index.mjs");
...
function createWindow() {
    ...
    var mainWindow = new electron__WEBPACK_IMPORTED_MODULE_0__.BrowserWindow(_object_spread_props(_object_spread({
        width: 900,
        height: 670,
        show: false,
        ...
        webPreferences: {
            preload: (0,path__WEBPACK_IMPORTED_MODULE_1__.join)(__dirname, '../preload/index.js'),
            sandbox: false
        }
    }));
    ...
    if (_electron_toolkit_utils__WEBPACK_IMPORTED_MODULE_2__.is.dev && process.env['ELECTRON_RENDERER_URL']) {
        mainWindow.loadURL(process.env['ELECTRON_RENDERER_URL']);
    } else {
        mainWindow.loadFile((0,path__WEBPACK_IMPORTED_MODULE_1__.join)(__dirname, '../renderer/index.html'));
    }
}
...
electron__WEBPACK_IMPORTED_MODULE_0__.app.whenReady().then(function() {
    ...
    _electron_toolkit_utils__WEBPACK_IMPORTED_MODULE_2__.electronApp.setAppUserModelId('com.electron');
    // Default open or close DevTools by F12 in development
    // and ignore CommandOrControl + R in production.
    // see https://github.com/alex8088/electron-toolkit/tree/master/packages/utils
    electron__WEBPACK_IMPORTED_MODULE_0__.app.on('browser-window-created', function(_, window) {
        _electron_toolkit_utils__WEBPACK_IMPORTED_MODULE_2__.optimizer.watchWindowShortcuts(window);
    });
    // IPC test
    electron__WEBPACK_IMPORTED_MODULE_0__.ipcMain.on('ping', function(event) {
        event.reply('pong', {
            message: 'copy that.',
